      ...
      <div className="container p-relative">
        <div className="row">
          <div className="col-sm-6 notyf-page__left">
            <h1>Notyf</h1>
            <h2>
              <p>A dead simple vanilla JavaScript toast plugin. Responsive, A11Y, dependency-free. Tiny (~3KB).</p>
              <p>Easy integration with React, Angular and Vue.</p>
            </h2>

            <div className="notyf-page__docs">
              <button>
            ...
            <p className="notyf-page__credits as-header">Carlos Roso © 2020</p>
            <Dots />
          </div>

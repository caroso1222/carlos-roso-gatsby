...
const NotyfPage = () => {
  ...
  const title = 'Notyf: A minimalist JavaScript library for toast notifications.';
  const description =
        ...
        <div className="container p-relative">
          <div className="row">
            <div className="col-sm-6 notyf-page__left">
              ...
              <h2>
                <p>
                  A minimalistic JavaScript library for toast notifications. Responsive, A11Y,
                  dependency-free. Tiny (~3KB).
                </p>
                    ...
                    <div className="d-flex">
                      <div className="d-flex mr-1 align-items-center">
                        <input
                          ...
                          ref={register}
                        ></input>
                        <label className="as-header" htmlFor="x-left">
                          Left
                        </label>
                      </div>
                      <div className="d-flex mr-1 align-items-center">
                        <input
                          ...
                          ref={register}
                        ></input>
                        <label className="as-header" htmlFor="x-center">
                          Center
                        </label>
                      </div>
                      <div className="d-flex mr-1 align-items-center">
                        <input
                          ...
                          ref={register}
                        ></input>
                        <label className="as-header" htmlFor="x-right">
                          Right
                        </label>
                      </div>
                    </div>
                    ...
                    <div className="d-flex">
                      <div className="d-flex mr-1 align-items-center">
                        <input
                          ...
                          ref={register}
                        ></input>
                        <label className="as-header" htmlFor="y-top">
                          Top
                        </label>
                      </div>
                      <div className="d-flex mr-1 align-items-center">
                        <input
                          ...
                          ref={register}
                        ></input>
                        <label className="as-header" htmlFor="y-right">
                          Bottom
                        </label>
                      </div>
                    </div>
                    ...
                    <div className="d-flex">
                      <div className="d-flex mr-1 align-items-center">
                        <input
                          ...
                          name="ripple"
                        ></input>
                        <label className="as-header" htmlFor="with-ripple">
                          With ripple
                        </label>
                      </div>
                      <div className="d-flex align-items-center">
                        <input
                          ...
                          name="dismissible"
                        ></input>
                        <label className="as-header" htmlFor="dismissible">
                          Dismissible
                        </label>
                      </div>
                    </div>
                    ...
                    <div className="d-flex">
                      <div className="d-flex mr-1 align-items-center">
                        <input
                          ...
                          ref={register}
                        ></input>
                        <label className="as-header" htmlFor="type-success">
                          Success
                        </label>
                      </div>
                      <div className="d-flex mr-1 align-items-center">
                        <input
                          ...
                          ref={register}
                        ></input>
                        <label className="as-header" htmlFor="type-error">
                          Error
                        </label>
                      </div>
                      <div className="d-flex mr-1 align-items-center">
                        <input
                          ...
                          ref={register}
                        ></input>
                        <label className="as-header" htmlFor="type-custom">
                          Custom
                        </label>
                      </div>
                    </div>
                  </section>
                  <button type="submit" className="notyf-page__cta as-header">
                    Fire!
                  </button>
                </form>
              </div>

...
const Footer = () => (
  <footer className="d-flex justify-content-between align-items-center footer">
    <h6 className="footer__info m-0">Carlos Roso © 2020</h6>
    <div className="footer__icons">
      <a
        href="https://twitter.com/caroso1222"
        target="_blank"
        rel="noopener noreferrer"
        className="d-inline-block footer__icon"
      >
        <svg width="16px" height="13px" viewBox="0 0 16 13" version="1.1">
          ...
          <g id="Page-1" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd" opacity="0.8">
            <g
              id="Desktop"
              transform="translate(-824.000000, -1151.000000)"
              fill="#000000"
              fillRule="nonzero"
            >
      ...
      <a
        href="https://www.linkedin.com/in/carlos-roso-41577886/"
        target="_blank"
        rel="noopener noreferrer"
        className="d-inline-block footer__icon"
      >
        <svg width="16px" height="16px" viewBox="0 0 16 16" version="1.1">
          <g id="Page-1" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd" opacity="0.8">
            <g
              id="Desktop"
              transform="translate(-902.000000, -1148.000000)"
              fill="#000000"
              fillRule="nonzero"
            >
